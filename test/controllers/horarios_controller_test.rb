...
class HorariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post horarios_url, params: { horario: { dia: @horario.dia, horaf: @horario.horaf, horai: @horario.horai } }
    end
  ...
  test "should update horario" do
    patch horario_url(@horario), params: { horario: { dia: @horario.dia, horaf: @horario.horaf, horai: @horario.horai } }
