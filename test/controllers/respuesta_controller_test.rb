...
class RespuestaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create respuestum" do
    assert_difference('Respuestum.count') do
      post respuesta_url, params: { respuestum: { correo: @respuestum.correo, descripcion: @respuestum.descripcion, nombre: @respuestum.nombre } }
    end
  ...
  test "should update respuestum" do
    patch respuestum_url(@respuestum), params: { respuestum: { correo: @respuestum.correo, descripcion: @respuestum.descripcion, nombre: @respuestum.nombre } }
